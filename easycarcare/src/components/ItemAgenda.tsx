...
interface Carro { status: string; modelo: string; placa: string; cliente: string; tempoRestante: string; equipe: string; servico: string; etapaRealizada: string; proximaEtapa: string }
...
export default function ItemAgenda() {
  const listaCarros = carros.map(carro => (
    <div key={carro.placa} className="bg-blue-950 text-white my-8 py-2 px-4">
